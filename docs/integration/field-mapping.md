...
This document provides a comprehensive mapping between the UI model (TaskDraft), the business model (Task), and the Obsidian-Tasks format.

## Complete Field Mapping Table

| UI Field (TaskDraft) | Business Model (Task) | Obsidian-Tasks | Type | Adapter Logic | Notes |
|----------------------|----------------------|----------------|------|---------------|-------|
...
| - | `doneAt` | done | ISO string? | Set when status = 'done' | Obsidian-Tasks compat |
...
### Obsidian-Tasks Priority Symbols
...
| UI Status | Business Model | Obsidian Symbol | Checkbox | Description |
|-----------|---------------|-----------------|----------|-------------|
...
- Obsidian-Tasks field compatibility
...
3. **Compatibility**: Obsidian-Tasks format support
